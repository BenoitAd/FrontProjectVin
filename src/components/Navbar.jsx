...
import logoVin from '../assets/img/logoVin.png'

export default function Navbar() {
    return (
      
    <nav class="bg-white border-gray-200 rounded dark:bg-gray-900">
      <div class="flex flex-wrap items-center justify-between ml-4 mr-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul class="flex flex-col min-w-max p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
