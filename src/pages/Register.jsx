         ...
         <>
                <section class="h-screen">
                  <div class="h-full text-gray-800">
                    <div
                      class="grid grid-cols-2 w-full h-full g-6"
                    >
                      <div
                        class="col-span-1 mb-12 md:mb-0 h-full inset-0"
                      >
                        <img
                          src={vignoble}
                      ...
                      <div class="col-span-1 w-full ">
                        ...
                        <div class="mt-24 my-10 flex items-center justify-center flex-col">
                                        <h1 class="text-6xl font-bold text-center  text-color ">Inscription</h1>
                                        <form class="px-4 my-10 max-w-3xl mx-auto space-y-6 " onSubmit={signUp}>
                                            <div class="mb-4 mt-4 space-y-6">
                                               ...
                                               <RegisterInput label="Mot de Passe" onChange={setPassword}/>
